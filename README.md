...
| Materi | Status |
|--------|--------|
| 🐍 Pengenalan Data Science | ✅ Completed |
| 📊 Python, NumPy & Pandas | ✅ Completed |
| 🧹 Data Cleaning | ✅ Completed |
| 📉 Statistika Dasar | ✅ Completed |
| 📈 Visualisasi Data | ✅ Completed |
...
| Icon | Tools | Keterangan |
|------|-------|------------|
| 🐍 | Python | Bahasa pemrograman utama |
| 📓 | Jupyter Notebook | Membuat dan menjalankan file `.ipynb` |
| ☁️ | Google Colab | Menjalankan notebook secara online |
| 💻 | Visual Studio Code | Code editor |
| 🔀 | Git | Sistem kontrol versi |
| 🌐 | GitHub | Penyimpanan repository secara public |
...
| 📊 Pandas | Manipulasi, membaca, membersihkan, dan menganalisis data |
| 📈 Matplotlib | Membuat visualisasi grafik dasar |
| 🎨 Seaborn | Membuat visualisasi statistik yang lebih informatif |
| 🤖 Scikit-Learn | Preprocessing data, train-test split, scaling, dan model Machine Learning |
...
### 6️⃣ Pertemuan 6 – Persiapan Data
